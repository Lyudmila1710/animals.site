               ...
               <h4 className="  pt-5 align-items-center text-center" style={{'minWidth': '250px'}}>{props.data.name}</h4>
                <div className="col-md-7">
                    ...
                    <div className="d-flex flex-row flex-wrap border m-5 p-3" style={{'minWidth': '200px'}}>
                        ...
                        <Link to={"/post1/" + props.data.id}>  <button type="button" className="btn btn-outline-light me-2" >Подробнее</button></Link></div>

                      </div>
                </div>
                <div className="col-md-5 d-flex justify-content-center">
                  <img src={'https://pets.сделай.site'+props.data.photos} className="img-fluid" style={{"height":"250px"}} alt="Животное" />
                </div>
              </div>
